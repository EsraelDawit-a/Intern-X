<template>
  <div :class="`${ darkmode ? 'dark-mode-on' :''}`">
      <div class="wrapper">
   <div class="left">

      <div v-if ="!signup"  class="left-inner">


         <div v-if="signin" class="sign-in-form active">
            <h1>Sign in to Intern-X</h1>
            <div class="social-buttons">
               ...
               <a href="javascript:;" title="Sign in via Apple">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <form action="">
               ...
               <div class="form-group remember-forgot">
                  ...
                  <div class="forgot">
                     <a href="#" @click="toggleForgotPass" class="forgot-pass-link">Forgot Password?</a>
                  </div>
               </div>
               <div class="form-group">
               ...
               <div class="create-aacount">
                  Not registered yet? <a href="#" @click="SignUp" class="text-underline sign-up-form-btn"> Create an Account</a>
               </div>
            </form>
         </div>
      ...
      <div v-if="!signin">
         ...
         <div >
            ...
            <form action="">
               ...
               <div class="create-aacount">
                  <a href="#" @click="toggleForgotPass" class="go-to-sign-in">Go Back</a>
               </div>
            </form>
         </div>
 <nuxt-link to="login"> 
     <Button cls ="fasf" value="fafiopi"></Button>
     </nuxt-link>
      </div>
      ...
      <div  v-if="signup"  >
         ...
         <div class="social-buttons">
            ...
            <a href="javascript:;" title="Sign up via Apple">
               <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M17.5172 12.5555C17.5078 10.957 18.232 9.75234 19.6945 8.86406C18.8766 7.69219 17.6391 7.04766 16.0078 6.92344C14.4633 6.80156 12.7734 7.82344 12.1547 7.82344C11.5008 7.82344 10.0055 6.96563 8.82891 6.96563C6.40078 7.00313 3.82031 8.90156 3.82031 12.7641C3.82031 13.9055 4.02891 15.0844 4.44609 16.2984C5.00391 17.8969 7.01484 21.8133 9.1125 21.75C10.2094 21.7242 10.9852 20.9719 12.4125 20.9719C13.7977 20.9719 14.5148 21.75 15.7383 21.75C17.8547 21.7195 19.6734 18.1594 20.2031 16.5563C17.3648 15.218 17.5172 12.6375 17.5172 12.5555V12.5555ZM15.0539 5.40703C16.2422 3.99609 16.1344 2.71172 16.0992 2.25C15.0492 2.31094 13.8352 2.96484 13.1437 3.76875C12.382 4.63125 11.9344 5.69766 12.0305 6.9C13.1648 6.98672 14.2008 6.40313 15.0539 5.40703V5.40703Z" fill="#111111" />
               </svg>
            </a>
         ...
         <form action="">
            ...
            <div class="create-aacount">
               Already registered? <a href="#" @click="SignUp" class="text-underline sign-in-form-btn"> Sign In</a>
            </div>
         </form>
      </div>
   </div>
   <div class="right">
      <div class="right-inner">
       <img  src="assets/img/logo/bg1.webp" alt="">

         <h2>Make a Difference with Your Online Resume!</h2>
         <p>Find the most exciting startup jobs, Connect with world of opportuinities</p>
      </div>
   </div>
</div>

<a href="#" @click="DarkMode" :class="`dark-mode-btn ${ darkmode ? 'active' :''}`" >
